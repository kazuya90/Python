...
class OutputExcelFile:
    ...
    """
    def __init__(self, df,output_folder_path,management_id,management_number,category,output_sheet_name):
        self.df = df
...
if __name__ == '__main__':
    ...
    OutputExcelFile(input_excel_file.df,folder_path,bulk_info.management_id,bulk_info.management_number,bulk_info.category,'テスト')